...
public interface BagADT<T> {
	...
	/*
	 * Modifisert noe i forhold til boken med at vi ikke har begrensing på
	 * størrelsen. En bag er en samling av elementer uten noen spesiell rekkefølge.
	 * Disse objektene er av samme type. En bag kan inneholde flere objekter av
	 * samme tilstand (samme data). Eks: Hvis bag'en inneholder ulike varer, så kan
	 * den samme varen finnes flere ganger i bag'en (flere kopier).
	 */
	/**
